package cn.aixuegao.common.configuration;
...
public class GenerateConfiguration {
	...
	/**包前缀*/
	public static final String PKG_PREFIX = "cn.aixuegao.";
	/**实体包后缀*/
	...
	/**连接名*/
	public final static String CONNECTION_NAME = "jdbc:mysql://127.0.0.1:3306/aixuegao-pc?useUnicode=true&amp;characterEncoding=utf-8";
	/**数据库用户名*/
	public final static String DB_USER = "root";
	/**用户密码*/
	public final static String DB_PASSWORD = "142536";
	/**驱动*/
