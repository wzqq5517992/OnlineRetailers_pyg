...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void update(Specification specification) {
		...
		com.pinyougou.pojo.TbSpecificationOptionExample.Criteria critera=example.createCriteria();
		critera.andSpecIdEqualTo(tbSpecification.getId());
